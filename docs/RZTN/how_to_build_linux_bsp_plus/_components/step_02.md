...
=== "RZ/T2H"
    ...
    -   **Security package**
        ...
        [:octicons-download-16: Get Security package](https://www.renesas.com/document/sws/rz-mpu-security-package-rzt2h-and-rzn2h-v5200){ .md-button .btn-round target=_blank}
    ...
    -   **Time-sensitive Network Package**
        ...
        [:octicons-download-16: Get Time-sensitive Network Package](https://www.renesas.com/document/swo/rzt2h-rzn2h-time-sensitive-network-package-v5000-rtk0ef0177z05000zj-rz-tsn-v5000zip){ .md-button .btn-round target=_blank}
...
[Back to the Getting Started >](../../RZTN/getting_started/index.md#step-3-obtain-and-build-renesas-rz-linux-bsp-plus-source-code){ .md-button .md-button--primary .btn-right }
